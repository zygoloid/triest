Squirtle SVG mini-library version 0.1
=====================================
...
geometric shapes, paths, polygons, etc work fine. Solid fills work on simply
connected shapes (those without holes), as do both linear and radial gradients.
Note that gradients may render slightly oddly due to vertex colouring.
